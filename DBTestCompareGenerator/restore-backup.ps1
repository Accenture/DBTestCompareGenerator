...
Write-Output "copy ./adventure-works-2008r2-oltp.bak to /var/opt/mssql/backup" 
docker cp "./adventure-works-2008r2-oltp.bak" sqlserver-container:/var/opt/mssql/backup
